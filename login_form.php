...
<body class="modal">
    <form class="space-y-4 modal-content" method="post" enctype="multipart/form-data" action="login_proses.php">
        <div>
        ...
        <div>
            <label class="text-sm font-medium mb-2">Login Sebagai</label>
            <select name="peran"
